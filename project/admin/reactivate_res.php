	...
	<table class="lists">
		...
		<tr>
			...
			<? $g = mysql_result($result, $i, "rdate");
				...
				?>
				<a class="submit" href="reac.php?id=<? echo mysql_result($result,$i,"id")?>&rid=<? echo mysql_result($result,$i,"rid")?>">Reactivate</a>
				<a class="submit" href="reactivate_res.php?del=<? echo mysql_result($result,$i,"id")?>">Delete</a>
				<? } else {?>
				<a class="submit" href="reactivate_res.php?del=<? echo mysql_result($result,$i,"id")?>">Delete</a>
				<?}?>
				</br>
