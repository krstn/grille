...
<? if($login==true){ if ($_COOKIE["type"]=="admin") { ?>
	...
	<center>
	<form method="post" action="can_res.php?id=<? echo $id; ?>" >
		...
		<table class="list" style="width:560px;height:374px;display:">
						...
						<tr>
							<td>Persons: </td>
							<td> <select name="persons" style="width:80px;"> 
						...
						<input style="display:none;" type="text" name="penalty" value="0" />
						<input style="display:none;" type="text" name="venue" value="not applicable" />
