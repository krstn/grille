...
?>
			...
			<div class="pageTitle"> Cancel Reservation </div>
			<?php if ($showForm==true){ ?>
			<center>
				<form method="post" action="can.php?id=<? echo $id; ?>&rid=<?echo $rid;?>">
				<div class="error"> <?php echo $errorMsg; ?>  </div>
				<br/>
						<div class="info"> Are you sure you want to continue to cancel?  </div>
						<input class="submit" type="submit" name="submit" value="OK"/>
						<input style="display:none" id="guest" name="ok" value="2"/>
			...
			<center>
			<div class="success"> 
				<div class="info"> Cancelation succesful </div>
