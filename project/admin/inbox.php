...
$h = mysql_result($result2,$i,"username");
}
$query3= "SELECT * FROM messages WHERE fname = '".$r."' and lname = '".$c."' and sender != '".$h."'  ";
	...
	<table class="lists">
		...
		$news = date("Y-M-d",strtotime($sdate));?>
			<tr>
				...
				<td class="button">
				<a class="submit" href="msg.php?id=<?echo mysql_result($result3,$i, "sender");?>">Reply</a>
				<a class="submit" href="inbox.php?del=<? echo mysql_result($result3,$i,"id")?>">Delete</a> 
				</td>
			</tr>
			<? } ?>
