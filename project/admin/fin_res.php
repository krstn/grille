	...
	<table class="lists">
		...
		<tr>
			...
			<?if ($result2 != 0) {?>
					...
					<a href="orders.php?id=<?echo mysql_result($result,$i,"rid");?>" class="submit">View Order</a>
					<? } ?>

				<a class="submit" href="fin_res.php?del=<? echo mysql_result($result,$i,"id")?>">Delete</a>
			...
			<br>
			<form method="post" action="fin_res.php">
	<?
		if(isset($error)) {
			echo $error;
		}
