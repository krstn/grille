...
?>
			...
			<div class="pageTitle"> Deactivate Product </div>
			<?php if ($showForm==true){ ?>
			<center>
				<form method="post" action="products_deact.php?id=<? echo $id; ?>">
				<div class="error"> <?php echo $errorMsg; ?>  </div>
				<br/>
						<div class="info"> Are you sure you want to continue to deactivate? </div>
						<input class="submit" type="submit" name="submit" value="OK"/>
						<input style="display:none" id="guest" name="ok" value="0"/>
			...
			<center>
			<div class="success"> 
				<div class="info"> Deactivated Product </div>
