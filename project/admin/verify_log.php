...
if (isset ($_POST["submit"])){
	...
	$sql=("UPDATE log SET veri='$ok' where id='$id' ");
...
?>
			...
			<center>
				<form method="post" action="verify_log.php?id=<? echo $id; ?>">
				...
				<br/>
						...
						<a class="submit" href="logs.php"> CANCEL </a>
